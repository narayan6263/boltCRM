...
import { fetchSearchContacts, clearSearchContacts } from '../redux/slice/index';
...
const DialerScreen = ({ visible, onClose, navigation }) => {
  ...
  // Refs to hold the latest state values for the AppState listener
  const callInitiatedRef = useRef(callInitiated);
  const selectedContactRef = useRef(selectedContact);
  const contactSearchQueryRef = useRef(contactSearchQuery);
    ...
    const handleAppStateChange = (nextAppState) => {
      ...
      if (
        ...
        console.log('DialerScreen: Call ended, navigating to ContactFeedbackForm with:', {
          phoneNumber: selectedContactRef.current?.phone || contactSearchQueryRef.current,
          contact: selectedContactRef.current || { phone: contactSearchQueryRef.current },
        });
