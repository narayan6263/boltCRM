...
// const MyLeadsTab = ({ navigation, empId, onLeadAdded }) => {
...
//     currentPage,
//     totalLeads,
//   } = useSelector((state) => state.leads.myLeads);
...
//   const formSlideAnim = useRef(new Animated.Value(-Dimensions.get('window').height * 0.65)).current;
...
//       console.log('MyLeadsTab: SearchFilterForm closed');
//     });
//   };

//   const handleResetFilters = () => {
//     if (empId) {
//       console.log(`MyLeadsTab: Resetting filters for empId=${empId}`);
//       dispatch(fetchAllLeads({ filters: { assignedTo: empId }, page: 1, refresh: true, limit: 10 }));
...
//     if (hasMore && !loading && empId) {
//       const filters = activeFilters ? { ...activeFilters, assignedTo: empId } : { assignedTo: empId };
//       console.log(`MyLeadsTab: Fetching more leads for page=${currentPage + 1}, filters=`, filters);
//       dispatch(fetchAllLeads({ filters, page: currentPage + 1, limit: 10 }));
//     }
//   };

//   const handleLeadAdded = () => {
//     if (empId) {
//       console.log(`MyLeadsTab: Lead added, refreshing leads for empId=${empId}`);
//       dispatch(fetchAllLeads({ filters: { assignedTo: empId }, page: 1, refresh: true, limit: 10 }));
//       setActiveFilters(null);
//       onLeadAdded();
//     }
...
//     if (empId) {
//       const combinedFilters = { ...filters, assignedTo: empId };
//       console.log('MyLeadsTab: Search submitted with filters=', combinedFilters);
//       dispatch(fetchAllLeads({ filters: combinedFilters, page: 1, refresh: true, limit: 10 }));
//       closeSearchForm();
//     }
//   }, 500);
...
//     console.log('MyLeadsTab: Opening DialerScreen');
//   };
...
//       : 'N/A';
//     return (
//       <TouchableOpacity onPress={() => handleLeadPress(item, formattedDate, formattedFollowUpDate)}>
//         <LeadCard
//           lead={item}
...
//         <StyledText className="text-gray-500 text-center mt-4">Loading employee data...</StyledText>
//       </StyledView>
//     );
//   }
...
//                 accessibilityLabel="Reset to my leads"
//               >
...
//             )}
//             <View>
//               <StyledText className="text-subHeading font-poppinsFont text-black">Total Lead</StyledText>
