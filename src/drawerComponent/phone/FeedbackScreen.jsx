...
const FeedbackScreen = ({ route, navigation }) => {
  const { phoneNumber = 'N/A', leadId, isManual = false, sourceScreen = 'LeadsScreen', queryType = '' } = route.params || {};
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (sourceScreen === 'LeadsScreen') {
        ...
        navigation.navigate(sourceScreen, { queryType: queryType, shouldRefresh: true });
      }
    } catch (error) {
